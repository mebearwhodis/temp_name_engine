...
struct Vec3iOperatorFixture :
    public ::testing::TestWithParam<std::pair<core::Vec3<int>, core::Vec3<int>>>
{
...
{
    auto [v1, v2] = GetParam();
    const auto result = core::Vec3<int>::Dot(v1, v2);
...
{
    auto [v1, v2] = GetParam();
    const auto result = core::Vec3<int>::Cross(v1, v2);
...
INSTANTIATE_TEST_SUITE_P(AllNumbers, Vec3iOperatorFixture,
    testing::Values(
        std::pair{ core::Vec3{-4, 3, 2}, core::Vec3{2, 4, -1} },
        std::pair{ core::Vec3{-10, -15, 5}, core::Vec3{-25, 35, 0} },
        std::pair{ core::Vec3{1, 3, 1}, core::Vec3{2, 4, 0} },
        std::pair{ core::Vec3{10, 15, 10}, core::Vec3{25, 35, 5} },
        std::pair{ core::Vec3<int>{}, core::Vec3<int>{} },
        std::pair{ core::Vec3{1, 5, 2}, core::Vec3<int>{} },
        std::pair{ core::Vec3<int>{}, core::Vec3{1, 7, 3} }
    )
);
...
struct Vec3fOperatorFixture :
    public ::testing::TestWithParam<std::pair<core::Vec3<float>, core::Vec3<float>>>
{
...
INSTANTIATE_TEST_SUITE_P(AllNumbers, Vec3fOperatorFixture,
    testing::Values(
        std::pair{ core::Vec3{-4.1f, 3.2f, 2.5f}, core::Vec3{2.3f, 4.5f, -1.1f} },
        std::pair{ core::Vec3{-10.5f, -15.3f, 5.0f}, core::Vec3{-25.8f, 35.2f, 0.0f} },
        std::pair{ core::Vec3{1.0f, 3.0f, 1.5f}, core::Vec3{2.2f, 4.1f, 0.8f} },
        std::pair{ core::Vec3{10.7f, 15.8f, 10.1f}, core::Vec3{25.3f, 35.4f, 5.5f} },
        std::pair{ core::Vec3<float>{}, core::Vec3<float>{} },
        std::pair{ core::Vec3{1.5f, 5.1f, 2.8f}, core::Vec3<float>{} },
        std::pair{ core::Vec3<float>{}, core::Vec3{1.9f, 7.6f, 3.3f} }
    )
);
