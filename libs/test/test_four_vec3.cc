...
namespace math
{
    TEST(FourVec3Test, Addition)
    {
        std::array<Vec3<float>, 4> a_arr = {
            Vec3<float>{1.0f, 2.0f, 3.0f}, Vec3<float>{4.0f, 5.0f, 6.0f}, Vec3<float>{7.0f, 8.0f, 9.0f}, Vec3<float>{10.0f, 11.0f, 12.0f}
        };
        std::array<Vec3<float>, 4> b_arr = {
            Vec3<float>{13.0f, 14.0f, 15.0f}, Vec3<float>{16.0f, 17.0f, 18.0f}, Vec3<float>{19.0f, 20.0f, 21.0f}, Vec3<float>{22.0f, 23.0f, 24.0f}
        };
    ...
    {
        std::array<Vec3<float>, 4> a_arr = {
            Vec3<float>{10.0f, 20.0f, 30.0f}, Vec3<float>{40.0f, 50.0f, 60.0f}, Vec3<float>{70.0f, 80.0f, 90.0f}, Vec3<float>{100.0f, 110.0f, 120.0f}
        };
        std::array<Vec3<float>, 4> b_arr = {
            Vec3<float>{1.0f, 2.0f, 3.0f}, Vec3<float>{4.0f, 5.0f, 6.0f}, Vec3<float>{7.0f, 8.0f, 9.0f}, Vec3<float>{10.0f, 11.0f, 12.0f}
        };
