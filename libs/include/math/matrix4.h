...
namespace math
{
    ...
    struct matrix4
    {
        ...
        constexpr matrix4(const Vec4<T>& row1, const Vec4<T>& row2, const Vec4<T>& row3, const Vec4<T>& row4) : rows{{row1, row2, row3, row4}} {}
        ...
        [[nodiscard]] constexpr T determinant() const
        {
            ...
            // along the first row
            return rows[0].x * math::matrix3<T>(Vec3<T>(rows[1].y, rows[1].z, rows[1].w), Vec3<T>(rows[2].y, rows[2].z, rows[2].w), Vec3<T>(rows[3].y, rows[3].z, rows[3].w)).determinant()
                   - rows[0].y * math::matrix3<T>(Vec3<T>(rows[1].x, rows[1].z, rows[1].w), Vec3<T>(rows[2].x, rows[2].z, rows[2].w), Vec3<T>(rows[3].x, rows[3].z, rows[3].w)).determinant()
                   + rows[0].z * math::matrix3<T>(Vec3<T>(rows[1].x, rows[1].y, rows[1].w), Vec3<T>(rows[2].x, rows[2].y, rows[2].w), Vec3<T>(rows[3].x, rows[3].y, rows[3].w)).determinant()
                   - rows[0].w * math::matrix3<T>(Vec3<T>(rows[1].x, rows[1].y, rows[1]. z), Vec3<T>(rows[2].x, rows[2].y, rows[2].z), Vec3<T>(rows[3].x, rows[3].y, rows[3].z)).determinant();
        }
